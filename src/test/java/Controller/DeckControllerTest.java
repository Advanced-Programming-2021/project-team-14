...
//        Request.setOption(String.format("deck add-card --card %s --deck %s", cardName, deckName), Strings.SIDE_OPTION.getLabel());
//        Request.send();
//    }
//
//    @Test
...
//        Request.setOption("deck rm-card --card Haniwa --deck toRemovedDeck", Strings.SIDE_OPTION.getLabel());
//        Request.send();
//
...
//        Request.setOption("deck rm-card --card notExistingCard --deck toNotExistingRemovedDeck", Strings.SIDE_OPTION.getLabel());
//        Request.send();
//
...
//        Request.setOption("deck rm-card --card Haniwa --deck notExistingDeck", Strings.SIDE_OPTION.getLabel());
//        Request.send();
//
//        Assertions.assertEquals(Request.getResponse(), String.format(Responses.DECK_NOT_EXIST.getLabel(), "notExistingDeck"));
//    }
...
//        Request.setOption("deck show --deck-name toShowMainDeck", Strings.SIDE_OPTION.getLabel());
//        Request.send();
//
...
//        Request.setOption("deck show --deck-name notExistingDeck", Strings.SIDE_OPTION.getLabel());
//        Request.send();
//
//        Assertions.assertEquals(Request.getResponse(), String.format(Responses.DECK_NOT_EXIST.getLabel(), "notExistingDeck"));
//    }
